...
parser.add_argument('--mode', default='WAGE', help='WAGE|FP|XNOR')
...
if args.dataset == 'cifar10':
    ...
    test_loader = dataset.get_imagenet(batch_size=args.batch_size, num_workers=1)
else:
...
if args.model == 'VGG8':
    ...
    ## Imagenet으로 할거면
        ...
        #model_path = './log/resnet18-5c106cde.pth'
        #modelCF = ResNet.resnet18(args = args, logger=logger, pretrained = True)

    ## Cifar10
    #if args.dataset == 'cifar10':
        #model_path = './log/default/ADCprecision=5/batch_size=64/cellBit=4/dataset=cifar10/decreasing_lr=140,180/detect=0/grad_scale=8/inference=0/lr=0.01/mode=FP/model=ResNet18/onoffratio=10/seed=117/subArray=128/t=0/target=0/v=0/vari=0/wl_activate=8/wl_error=8/wl_grad=8/wl_weight=8/best-119.pth'
    
    if args.mode == 'XNOR':
        model_path = './log/default/ADCprecision=5/batch_size=64/cellBit=4/dataset=cifar10/decreasing_lr=140,180/detect=0/grad_scale=8/inference=0/lr=0.01/mode=XNOR/model=ResNet18/onoffratio=10/seed=117/subArray=128/t=0/target=0/v=0/vari=0/wl_activate=8/wl_error=8/wl_grad=8/wl_weight=8/best-186.pth'
